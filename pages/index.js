      ...
      <>
        ...
        >
          <div className="flex flex-col-reverse h-screen">
            <nav className="z-50 overflow-x-auto bg-indigo-300 dark:bg-neutral-800 dark:text-green-400 min-h-[74px] flex flex-col-reverse">
            ...
            <div className="flex flex-col-reverse h-full bg-gradient-to-br from-neutral-600 to-indigo-500 dark:bg-neutral-700 p-4 gap-y-4 overflow-x-auto max-w-screen items-center">
      ...
      >
        <div className="flex flex-col h-screen">
          <DesktopNav
            ...
            resumeList={resumeList}
          />
          <div className="flex h-full bg-gradient-to-br from-neutral-600 to-indigo-500 dark:bg-neutral-700 pb-0 gap-x-4 overflow-x-scroll max-w-screen pt-4 hide-scroll">
            <div className="h-full min-w-[300px] overflow-y-auto hide-scroll gap-3 flex flex-col px-4 pb-4">
              <h1 className="sticky top-0 bg-indigo-200 text-center p-1 font-bold tracking-widest z-50 flex justify-center gap-1">
                resumes
                <p className="text-sm">
